...
print("__________________ELEI��ES_____________________\n")
print("_______________________________________________\n\n\n")
num = input("INSIRA O N�MERO DO SEU CANDIDATO A PRESID�NCIA:\n--")
print("_______________________________________________\n\n\n")
...
match int(num):
    ...
    case 30:
        print("Jo�o Amo�do(Novo):30 \n\n\n")
    
    case 54:
        print("Jo�o Vicente Goulart(PPL):54 \n\n\n")
    
    case 18:
        print("Marina Silva(Rede):18 \n\n\n")
    
    case 16:
        print("Vera L�cia(PSTU):16 \n\n\n")
    case _:
	    print("_____________Candidato Inv�lido________________ \n\n\n")
	
print("_______________________________________________\n\n\n")
gov = input("INSIRA O N�MERO DO SEU CANDIDATO A GOVERNADOR:")
print("_______________________________________________\n\n\n")
